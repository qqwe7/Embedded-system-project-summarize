...
static void oled_data_out(uint8_t data)
{
    ...
    sys_gpio_pin_set(GPIOC, SYS_GPIO_PIN11, data >> 4); /* D4 */
    sys_gpio_pin_set(GPIOB, SYS_GPIO_PIN6, data >> 5);  /* D5 */
    sys_gpio_pin_set(GPIOE, SYS_GPIO_PIN5, data >> 6);  /* D6 */
    sys_gpio_pin_set(GPIOE, SYS_GPIO_PIN6, data >> 7);  /* D7 */ 
}
...
void oled_init(void)
{
    ...
    RCC->AHB1ENR |= 0X1F;   /* 使能PORTA/B/C/D/E时钟 */
    RCC->AHB1ENR |= 1 << 6; /* 使能PORTG时钟 */

    sys_gpio_set(GPIOA, SYS_GPIO_PIN4 | SYS_GPIO_PIN6,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PA4,6设置 */

    sys_gpio_set(GPIOB, SYS_GPIO_PIN6 | SYS_GPIO_PIN7,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PB6,7设置 */

    sys_gpio_set(GPIOC, SYS_GPIO_PIN6 | SYS_GPIO_PIN7 | SYS_GPIO_PIN8 | SYS_GPIO_PIN9 | SYS_GPIO_PIN11,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PC6~9,PC11设置 */

    sys_gpio_set(GPIOD, SYS_GPIO_PIN6 | SYS_GPIO_PIN7,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PD6,7 设置 */
    
    sys_gpio_set(GPIOE, SYS_GPIO_PIN5 | SYS_GPIO_PIN6,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PE5,6 设置 */

    sys_gpio_set(GPIOG, SYS_GPIO_PIN15,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PG15 设置 */
