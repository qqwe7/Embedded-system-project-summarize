...
#define ATIM_TIMX_CPLM_CHY_GPIO_AF              1                                           /* AF功能选择 */
#define ATIM_TIMX_CPLM_CHY_GPIO_CLK_ENABLE()    do{ RCC->AHB1ENR |= 1 << 4; }while(0)       /* PE口时钟使能 */

/* 互补输出通道引脚 */
#define ATIM_TIMX_CPLM_CHYN_GPIO_PORT           GPIOE
#define ATIM_TIMX_CPLM_CHYN_GPIO_PIN            SYS_GPIO_PIN8
#define ATIM_TIMX_CPLM_CHYN_GPIO_AF             1                                           /* AF功能选择 */
#define ATIM_TIMX_CPLM_CHYN_GPIO_CLK_ENABLE()   do{ RCC->AHB1ENR |= 1 << 4; }while(0)       /* PE口时钟使能 */
...
#define ATIM_TIMX_PWMIN_CHY_GPIO_AF             3                                           /* AF功能选择 */
#define ATIM_TIMX_PWMIN_CHY_GPIO_CLK_ENABLE()   do{ RCC->AHB1ENR |= 1 << 2; }while(0)       /* PC口时钟使能 */
...
#define ATIM_TIMX_PWMIN_CHY_CLK_ENABLE()        do{ RCC->APB2ENR |= 1 << 1; }while(0)       /* TIM8 时钟使能 */
