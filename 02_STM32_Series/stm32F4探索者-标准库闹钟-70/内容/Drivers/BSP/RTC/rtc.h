...
void rtc_set_alarma(uint8_t week, uint8_t hour, uint8_t min, uint8_t sec);  /* 设置闹钟A */
void rtc_set_alarmb(uint8_t week, uint8_t hour, uint8_t min, uint8_t sec);  /* 设置闹钟B */
