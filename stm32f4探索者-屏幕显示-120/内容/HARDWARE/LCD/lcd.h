...
//LCD_BL引脚宏定义
#define LCD_BL_Pin    GPIO_Pin_15	    // LED1
/* LCD 背光控制 */
...
/******************************************************************************************/
/* 函数申明 */
void LCD_WR_REG(vu16 regval);          //写LCD寄存器
void LCD_WR_DATA(vu16 data);           //写LCD数据
...
void LCD_Show_Char(u16 x,u16 y,u8 num,u16 fc,u16 bc,u8 sizey,u8 mode);      //显示一个指定颜色字符
void LCD_ShowNum(u16 x,u16 y,u32 num,u8 len,u8 size);  						//显示一个数字
void LCD_ShowxNum(u16 x,u16 y,u32 num,u8 len,u8 size,u8 mode);				//显示 数字
void LCD_ShowString(u16 x,u16 y,u16 width,u16 height,u8 size,u8 *p);		//显示一个字符串,12/16字体

void LCD_ShowChinese(u16 x,u16 y,u16 width, u16 height,u8 *s,u16 fc,u16 bc,u8 sizey,u8 mode);     //显示汉字串
...
void Show_Str(u16 x, u16 y,u8 *str,u16 fc, u16 bc,u8 sizey,u8 mode);        //显示一个字符串,包含中英文显示

void LCD_ShowPicture(u16 x,u16 y,u16 width,u16 height,const u8 pic[]);      //显示图片
